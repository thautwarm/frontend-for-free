...
(lexicals, run_lexer) = lexer(r(WS='\\s+'), r(QuotedStr='"([^\\\\"]+|\\\\.)*?"|\'([^\\\\\']+|\\\\.)*?\''), r(Ident='[a-zA-Z_\\u4e00-\\u9fa5][a-zA-Z0-9_\\u4e00-\\u9fa5]*'), l[','], l['%reserve'], l['%require'], l['%include'], l['%ignore'], ignores=['WS'], reserved_map=ImmutableMap.from_dict({',': 'quote ,', '%ignore': 'quote %ignore', '%reserve': 'quote %reserve', '%require': 'quote %require', '%include': 'quote %include'}), numbering={'BOF': 0, 'EOF': 1, 'quote ,': 2, 'quote %ignore': 3, 'quote %reserve': 4, 'quote %require': 5, 'quote %include': 6, 'WS': 7, 'QuotedStr': 8, 'Ident': 9})
...
def mk_parser(literal, unesc):
    ...
    def lr_step_rbnf__sep__list__2(_slot_0, prim__state, prim__tokens):
        ...
        if lcl_0:
            ...
            lcl_1 = parse_require__able(prim__state, prim__tokens)
            _slot_2_check = lcl_1
            lcl_1 = _slot_2_check[0]
            lcl_1 = (lcl_1 is False)
            if lcl_1:
                ...
                if (lcl_3 == 4):
                    ...
                    if lcl_4:
                        ...
                        if lcl_5:
                            ...
                            lcl_6 = prim__mk__ast('START', lcl_6)
                    ...
                    lcl_4 = (_off_1, 'START lookahead failed')
    ...
    def parse_ignore(prim__state, prim__tokens):
        ...
        if lcl_0:
            ...
            lcl_1 = parse_rbnf__sep__list__1(prim__state, prim__tokens)
            _slot_1_check = lcl_1
    ...
    def parse_include(prim__state, prim__tokens):
        ...
        if lcl_0:
            ...
            if lcl_1:
                ...
                lcl_3 = lcl_3.idint
                if (lcl_3 == 8):
                    lcl_4 = parse_rbnf__sep__list__3(prim__state, prim__tokens)
                    _slot_1_check = lcl_4
                    lcl_4 = _slot_1_check[0]
                    lcl_4 = (lcl_4 is False)
                    if lcl_4:
    ...
    def parse_rbnf__sep__list__2(prim__state, prim__tokens):
        lcl_0 = parse_require__able(prim__state, prim__tokens)
        _slot_0_check = lcl_0
        lcl_0 = _slot_0_check[0]
        lcl_0 = (lcl_0 is False)
        if lcl_0:
    ...
    def parse_require(prim__state, prim__tokens):
        lcl_0 = 5
        try:
            _py_local_tk = prim__tokens.array[prim__tokens.offset]
            if (_py_local_tk.idint is lcl_0):
        ...
        if lcl_0:
            lcl_1 = prim__tokens.offset
            lcl_1 = (lcl_1, 'quote %require not match')
            lcl_1 = prim__cons(lcl_1, prim__nil)
            lcl_1 = lcl_1
            lcl_1 = (False, lcl_1)
            lcl_0 = lcl_1
    ...
    def parse_require__able(prim__state, prim__tokens):
        lcl_0 = 9
        try:
            _py_local_tk = prim__tokens.array[prim__tokens.offset]
            if (_py_local_tk.idint is lcl_0):
    ...
    def parse_stmt(prim__state, prim__tokens):
        ...
        if lcl_0:
            ...
            if (lcl_2 == 4):
                ...
                lcl_3 = parse_require(prim__state, prim__tokens)
                _slot_0_check = lcl_3
                lcl_3 = _slot_0_check[0]
                lcl_3 = (lcl_3 is False)
                if lcl_3:
